...
def genetic_algorihtm(start_municipality="Leiden", population_size=30, elitism_size=3, tournament_size=5,
...
if __name__ == "__main__":
    ...
    threading.Thread(target=run_repetitions, kwargs={"wait": 3}, daemon=True).start()
